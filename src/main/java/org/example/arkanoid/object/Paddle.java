...
public class Paddle extends MoveAbleObject {
    ...
    public Paddle(double x, double y, double width, double height,
        ...
        this.speed = speed;
        try {
            image1 = new Image(getClass().getResourceAsStream("/Images/paddle/paddle1.png")); // Đường dẫn đến ảnh 1
            image2 = new Image(getClass().getResourceAsStream("/Images/paddle/paddle2.png")); // Đường dẫn đến ảnh 2
        } catch (Exception e) {
